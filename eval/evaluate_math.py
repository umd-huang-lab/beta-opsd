...
def load_vllm_model(
    ...
    Args:
        ...
        enforce_eager: If True (default), disables CUDA graphs. Pass False for faster CUDA graph path.
    ...
    llm_config = {
        ...
        # True = eager (default, compatibility). Set enforce_eager=False for CUDA graphs / faster inference.
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        default=38912,
        help="Maximum tokens to generate (default: 38912)",
    )
    parser.add_argument(
        "--enable_thinking",
        action="store_true",
    ...
    parser.add_argument(
        ...
        type=int,
        default=6,
        help="Number of solutions to sample per problem / pass@n (default: 6)",
    )
    parser.add_argument(
        "--no-enforce-eager",
        dest="enforce_eager",
        action="store_false",
        help="Use CUDA graphs instead of eager mode (faster; default is enforce_eager=True)",
    )
    ...
    print(f"vLLM enforce_eager (default True; use --no-enforce-eager for CUDA graphs): {args.enforce_eager}")
    print("=" * 70 + "\n")
