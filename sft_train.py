...
class CustomScriptArguments(ScriptArguments):
    """Extended script arguments for baseline SFT runs."""

    run_config: str = field(
        default=None,
        metadata={
            "help": "Run name for this experiment. Used for output_dir subdirectory and WandB run name."
        },
    )
